...
for nombre in liste_nombres:
    print("coche ",nombre," reste ",len(liste_grilles))
    coche(nombre)
    if len(liste_grilles)==1 :
        print(nombre)
        print(nombre * calculePoint(0))
        imprimeGrille(0)
        exit()
    grilleGagnante = verifieGrille()
    while grilleGagnante!=None :
        print("grille gagnante : ",grilleGagnante,nombre,len(liste_grilles))
        liste_grilles.pop(grilleGagnante)
        grilleGagnante = verifieGrille()
