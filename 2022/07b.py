...
print("recherche repertoires ideal")
# parcourir les differents repertoires et verifier leur taille
tailleRepertoireASupprimer = 30000000
liste = []
liste.append(arborescence)
while len(liste)>0 :
    repertoire = liste.pop()
    if repertoire.taille>913445 and repertoire.taille < tailleRepertoireASupprimer :
        tailleRepertoireASupprimer = repertoire.taille
    for r in repertoire.repertoires:
        liste.append(r)

print(tailleRepertoireASupprimer)